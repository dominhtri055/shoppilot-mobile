  ...
  return (
    <KeyboardAvoidingView style={styles.container} behavior={Platform.select({ ios: "padding", android: undefined })}>
      <Card>
        ...
        <Text style={styles.subtitle}>Sign in to manage products, orders, inventory, and store insights.</Text>
        ...
        <TextInput value={password} onChangeText={setPassword} autoCapitalize="none" autoComplete="password" secureTextEntry placeholder="Enter your password" style={styles.input} onSubmitEditing={() => void handleLogin()} />
        <AppButton title={loading ? "Signing in..." : "Sign in"} onPress={() => void handleLogin()} disabled={loading} />
        <Text style={styles.footerText}>New merchant? <Link href={"/register" as Href} style={styles.link}>Create an account</Link></Text>
      </Card>
